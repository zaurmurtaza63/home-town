...
<h2 className="text-xl font-semibold text-[#1a2a33]">Register</h2>
...
<input type="tel" placeholder="Phone Number" className="border border-gray-300 rounded-md px-4 py-2 focus:border-[#1ABC9C] focus:outline-none" />
<input type="password" placeholder="Password" className="border border-gray-300 rounded-md px-4 py-2 focus:border-[#1ABC9C] focus:outline-none" />
<button className="bg-[#1ABC9C] text-white py-2 rounded-md hover:bg-[#169c82] transition">Register</button>
</form>
</motion.div>
);
};
